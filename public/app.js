...
function getCountryOtpQualityMeta(country) {
    ...
    const hasEnoughData = completedOrders >= 20 && Boolean(rawQuality.hasEnoughData);
    const label = hasEnoughData ? String(rawQuality.label || 'Good OTP') : 'Good OTP';
...
function sortCountriesByOtpQuality(countries) {
...
function renderCountries() {
    ...
    filtered = sortCountriesByOtpQuality(filtered);
    if (!filtered.length) {
