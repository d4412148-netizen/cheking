...
const SMTP_HOST = getFirstConfiguredEnvValue(['SMTP_HOST', 'MAIL_HOST', 'EMAIL_HOST']);
...
function buildMailTransportCandidates() {
    if ((!SMTP_URL && !SMTP_SERVICE && !SMTP_HOST && !(SMTP_USER && SMTP_PASS)) || !SMTP_FROM) {
        return [];
    }
    const inferredSmtpService = !SMTP_URL && !SMTP_SERVICE && !SMTP_HOST && SMTP_USER && SMTP_PASS ? 'gmail' : '';
